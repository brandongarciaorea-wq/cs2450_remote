...
Date 11.19.25: This week in class we learned about security and the different ways it can be broken. We looked at some examples of how hackers get your information and the differenct costs of it. I learned that a security breach can be worth millions and that a lot of the time many companies just pay the hackers. It was a good thing to be aware of since the best way to stop these hackers is to simply be aware of it.   
